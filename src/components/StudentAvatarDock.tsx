...
export const StudentAvatarDock: React.FC<StudentAvatarDockProps> = ({
  ...
  const groupThemes = [
    {
      ...
      borderActive: 'border-rose-400 bg-rose-500/25 text-white ring-2 ring-rose-500/80',
      badgeBg: 'bg-rose-500 text-white',
      ringColor: 'ring-2 ring-rose-500 ring-offset-2 ring-offset-[#0d1527]'
    },
    {
      label: '2. Grup',
  ...
  // Scroll controls for avatar dock
  const scrollLeft = () => {
